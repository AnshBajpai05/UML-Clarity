...
const Dashboard = () => {
    ...
    React.useEffect(() => {
        ...
        fetch(`http://127.0.0.1:8000/api/document/${encodeURIComponent(docId)}/use-cases`)
    ...
    const handleDropAll = useCallback(() => {
        ...
        const useCases = unplaced.filter(n => n.category !== 'actor');
        ...
        if (useCases.length > 0) {
            ...
            canvas.spawnNode({
                id:       'auto-system-boundary',
                label:    'System',
                category: 'system',
                jointType:'uml.SystemBoundary',
                fullDescription: 'System boundary',
            }, sbX, sbY, sbW, sbH);
        }
